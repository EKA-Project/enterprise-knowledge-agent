...
export default function AdminDashboardView() {
  // Data for the 4 stat cards (mock data — will come from API later)
  const stats = [
  ...
  return (
    <div style={{ padding: '32px' }}>
      {/* Header section — date, greeting, and description */}
      ...
      {/* Stat cards grid — loops over the stats array to create 4 cards */}
